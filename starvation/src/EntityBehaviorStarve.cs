...
namespace Starvation
{
    public class EntityBehaviorStarve : EntityBehavior
    {
        ...
        private void _ServerTickSlow(float deltaTime)
        {
            ...
            bh.SetMaxHealthModifiers("starvationMod", (float) healthPenalty);
            // Remove vanilla stat boosts from food groups
            bh.SetMaxHealthModifiers("nutrientHealthMod", 0);
            ...
            _ = entity.Stats.Set("walkspeed", "starvationmod", -1 * MoveSpeedPenalty(), false);

            // Weaker damage and slower mining
            _ = entity.Stats.Set("meleeWeaponsDamage", "starvationmod", damageMul, false);
            _ = entity.Stats.Set("rangedWeaponsDamage", "starvationmod", damageMul, false);
            _ = entity.Stats.Set("mechanicalsDamage", "starvationmod", damageMul, false);
            _ = entity.Stats.Set("bowDrawingStrength", "starvationmod", damageMul, false);
            _ = entity.Stats.Set("miningSpeedMul", "starvationmod", damageMul, false);
        ...
        private void _ServerTick250(float deltaTime)
        {
            ...
            energyReserves -= kJPerGameSecond * gameSeconds * gameHungerSpeed;
        }
